    ...
    <SafeAreaView style={styles.container}>
        <View style = {{borderWidth : 1,flex : 2.3,backgroundColor : '#002333'}}>
            ...
            <View style={{flex : 1,borderColor : 'red',paddingLeft : 25,justifyContent : 'center'}}>
                <Text style = {{color:'white',fontSize : 30,fontWeight : 'bold'}}>Biology</Text>
            ...
            <View style = {{flex : 1,alignItems : 'center',}}>
                <ScrollView style = {{flex : 1,width : '100%',}}>
                    <View style = {{alignItems : 'center'}}>
                        ...
                        <TouchableOpacity onPress={() => props.navigation.navigate("TopTabNavigator")} style= {{borderColor : 'green',height : 150,marginTop : 20,width : '90%',borderRadius : 8, backgroundColor : 'white'}}>
