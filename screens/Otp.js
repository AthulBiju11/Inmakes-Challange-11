    ...
    <View style={styles.container}>
        <View style = {{flex :3,alignItems:'center',justifyContent : 'center'}}>
            ...
            <View style ={{alignItems : 'center',justifyContent : 'center',width:'100%',flex :1.5,paddingBottom: 10,}}>
                <Text style={styles.loremIpsum2}>Verification Code</Text>
                <Text style={styles.loremIpsum3}>Please type the verification code sent to</Text>
                <Text style={{marginTop : 15,fontSize : 16}}>+91 9876543210</Text>

            </View>
        </View>
        <View style = {[{flex :1.2,justifyContent : 'center'},styles.rect]}>
            <View style={{alignItems : 'center',flexDirection : 'row', flex:1.6,}}>
            <TextInput
            placeholder=""
            ...
            <View style={{flex : 1,alignItems: 'center'}}>
                ...
                style={styles.button}>
                    ...
                    <Text style={styles.loremIpsum}>Resend OTP</Text>
                
                </TouchableOpacity>
            </View>
            <View style={{flex : 2,alignItems: 'center',justifyContent: 'center',}}>
                <Text style={[styles.loremIpsum3,{}]}>Resend After 28s</Text>
                <View style = {{flexDirection : "row",paddingTop : 10}}>
                    <Icon name="ios-call" size={""}></Icon>
                    <Text>  </Text>
